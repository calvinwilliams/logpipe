...
int FUNCNAME_DSCLOG_logpipe_conf( logpipe_conf *pst )
{
	int	index[10] = { 0 } ; index[0]++; index[0] = 0 ;
		...
		PREFIX_DSCLOG_logpipe_conf "logpipe_conf.rotate.file_rotate_max_size[%u]" NEWLINE_DSCLOG_logpipe_conf , pst->rotate.file_rotate_max_size );
		PREFIX_DSCLOG_logpipe_conf "logpipe_conf.comm.compress_algorithm[%s]" NEWLINE_DSCLOG_logpipe_conf , pst->comm.compress_algorithm );
